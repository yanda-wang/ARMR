...
class EvaluationMedRec:
    """
    class for evaluating the MedRec model
    """
    ...
    def __init__(self, device, concept2id_mapping_file, patient_records_file, ddi_matrix_file,
        ...
        :param concept2id_mapping_file: file for Concept2Id
        :param patient_records_file: patient records file
        :param ddi_matrix_file: file for ddi matrix
        :param predict_prob_threshold: outputs with probability greater than predict_prob_threshold will be predicted
        :param ehr_matrix_file: file for co-occurrence matrix
        """
        self.device = device
    ...
    def evaluateIters(self):
        ...
        for _ in range(patient_count):
            ...
            tmp_final.append(predict_medications)
    ...
    def evaluate(self, load_model_name, patient_ddi_rate, input_size, hidden_size, encoder_n_layers,
                 encoder_bidirectional, hop, attn_type_kv='dot', attn_type_embedding='dot'):
        ...
        self.encoder = EncoderRNNQuery(self.device, input_size, hidden_size, self.diagnoses_count,
                                       self.procedures_count, encoder_n_layers, bidirectional=encoder_bidirectional)
        self.decoder = DecoderMultiHopKeyValueSeparate(self.device, hidden_size, self.medication_count,
        ...
        self.data_loader = DataLoaderMedRec(self.patient_records_file, patient_ddi_rate, 'test')
        self.evaluateIters()
...
class EvaluationUtil:
    ...
    def precision_auc(self, predict_prob, target_multi_hot):
        return average_precision_score(target_multi_hot, predict_prob, average='macro')
